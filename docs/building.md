...
**Актуально для INAV 6.1, 7.0**

В конфигураторе

![Настройка OSD](./assets/building/osdInav01.jpg)


* Выбираем у порта, куда подпаяны RX/TX в периферии "MSP Displayport".
  Галочку MSP ставить - **НЕ НУЖНО** ;

![Настройка OSD](./assets/building/osdInav02.jpg)


* Выбираем видеоформат (в случае с дисплейпортом - это размеры поля для элементов);
* Перетаскиваем нужные элементы;

_Фиолетовым цветом выделена зона, ниже которой отображаются системные данные (которые рисуют сами очки, как то напряжение, битрейт и прочее)
Красным цветом выделена зона, если у вас камера с соотношением сторон 4:3_

Инструкция будет дополнятся деталями по мере надобности.
@r1000ru (Roman Sorokin)
